...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Htcoin Core Htcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Htcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Htcoin transaction") + "\n" +
              "  Htcoin-tx [options] -create [commands]   " + _("Create hex-encoded Htcoin transaction") + "\n" +
              "\n";
