...
// Copyright (c) 2011-2012 Htcoin Developers
// Copyright (c) 2013 Htcoin Developers
...
*/
    ...
    loop
    {
		...
		/*
        if (fTestNet) {
            Send(hSocket, "JOIN #HtcoinTEST3\r");
            Send(hSocket, "WHO #HtcoinTEST3\r");
        } else { */
            // randomly join #Htcoin00-#Htcoin99
            int channel_number = GetRandInt(100);
            channel_number = 0; // Htcoin: for now, just use one channel
            Send(hSocket, strprintf2("JOIN #Htcoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf2("WHO #Htcoin%02d\r", channel_number).c_str());
       // }
